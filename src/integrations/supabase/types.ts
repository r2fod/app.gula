    ...
    Tables: {
      ...
      ingredients: {
        Row: {
          ...
          cost_per_unit: number | null // Campo nuevo solicitado
          waste_percentage: number | null // Campo nuevo solicitado
          supplier_id: string | null // Campo nuevo solicitado
          updated_at: string
          user_id: string
        }
        Insert: {
      ...
      recipes: {
        Row: {
          ...
          model_3d_url: string | null // Campo nuevo solicitado
          updated_at: string
          user_id: string
        }
        Insert: {
